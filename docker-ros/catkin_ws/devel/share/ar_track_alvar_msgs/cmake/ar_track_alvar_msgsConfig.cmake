...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /catkin_ws/src/ar_track_alvar/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /catkin_ws/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /catkin_ws/install)
...
if(NOT "/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
